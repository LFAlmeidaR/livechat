...
class NodeTriggerBuilder extends Component {
    ...
    render() {
        ...
        if (this.props.currenttrigger.get('currenttrigger').has('actions')) {
            var canned_ids = this.props.currenttrigger.get('currenttrigger').get('canned_ids');
