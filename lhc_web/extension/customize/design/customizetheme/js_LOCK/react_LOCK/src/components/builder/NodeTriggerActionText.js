...
class NodeTriggerActionText extends Component {
    ...
    constructor(props) {
        ...
        this.setCannedMsgID = this.setCannedMsgID.bind(this);
    ...
    setCannedMsgID(e){
        this.props.onChangeContent({id : this.props.id, 'path' : ['content','canned_msg_id'], value : e.target.value});
    }
    ...
    createOptions(){
        var a = [];
        this.props.canned_ids.map((i) => {
            a.push(<option value={i.get('id')}>{i.get('title')}</option>);
        });
            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="form-group">
                        ...
                        <select className="form-control form-control-sm" defaultValue={this.props.action.getIn(['content','canned_msg_id'])} onChange={this.setCannedMsgID.bind(this)}>
