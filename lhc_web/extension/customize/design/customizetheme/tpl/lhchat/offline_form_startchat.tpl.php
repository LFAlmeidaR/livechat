...
<div class="btn-group" role="group" aria-label="...">
    ...
    <?php $startChatText = erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Leave a message');?>
    <?php if (isset($theme) && $theme !== false && isset($theme->bot_configuration_array['custom_start_button_offline']) && !empty($theme->bot_configuration_array['custom_start_button_offline'])) {
        $startChatText = htmlspecialchars($theme->bot_configuration_array['custom_start_button_offline']);
    } ?>
