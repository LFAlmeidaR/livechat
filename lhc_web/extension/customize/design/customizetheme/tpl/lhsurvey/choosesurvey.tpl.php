<?php $modalHeaderTitle = erTranslationClassLhTranslation::getInstance()->getTranslation('survey/choosesurvey','Choose a survey');?>
...
<div class="tab-content">
	<div role="tabpanel" class="tab-pane active" id="survey-<?php echo $chat->id?>">
        ...
        <br/>
        <input type="submit" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('survey/choosesurvey','Request user');?>" class="btn btn-secondary" onclick="lhinst.chooseSurvey('<?php echo $chat->id;?>')" />
	</div>
